...
Так как у вас не настроена база музыки, то ничего полезного вы у себя не увидите. Но не расстраивайтесь, это лишь начало.
...
Цифры на кнопках звуков [2] работают аналогично. При нажатии на клавишу с цифрой на боковой клавиатуре сработает соответствующий ей звук.
...
Если вы создавали базу с помощью bat-файла, то ее нужно загрузить в плеер вручную.
 ...
 После каждого обновления базы с музыкой, файл нужно будет загружать заново.
